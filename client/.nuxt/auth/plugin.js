...
export default function (ctx, inject) {
  ...
  // local
  $auth.registerStrategy('local', new scheme_003d9a64($auth, {"endpoints":{"login":{"url":"login","method":"post","propertyName":"meta.token"},"logout":{"url":"/api/auth/logout","method":"post"},"user":{"url":"me","method":"get","propertyName":"data"}},"_name":"local"}))
